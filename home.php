...
if( isset($_POST['updatepwd']) ){
	...
	if( empty($_POST['newpwd']) ){
		$msg .= "New pwd is required<br>";
	}else{
		$newpwd=vld_input($_POST['newpwd']);
	}
	if( $row['pwd']!=$oldpwd ){
	...
	if($msg==""){
		$dor=date('Y-m-d');
		$sql = "UPDATE `users` SET `pwd`='$newpwd' WHERE `userid`='$sessuserid'";
		if( mysqli_query($conn, $sql) ){
				...
				<div class="col-md-4">
					<aside class="mt-5 mt-xl-0">
							...
							<div class="widget-inner">
								<div class="widget-title">
									<div class="profile-pic">
										<img src="<?php echo $row['propic']; ?>" class="img-thumbnail img-fluid" width="100%">
									</div>
									<h5><?php echo $row['name']; ?> <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#mypropic">Change proPic</button></h5>
								</div>
							</div>
						</div>
						<div class="widget active-group">
							<div class="widget-inner">
								<div class="widget-title">
									<h6><i class="fa-solid fa-male"></i> <?php echo $row['gender']; ?></h6>
									<h6><i class="fa-solid fa-location"></i> <?php echo $row['city']; ?></h6>
									<h6><i class="fa-solid fa-phone"></i> <?php echo $row['mobile']; ?></h6>
									<h5> <button class="btn btn-primary btn-sm pull-left" data-toggle="modal" data-target="#changepwd">Change password</button></h5>
						...
						<div class="lab-inner">
							<div class="lab-thumb">
								<div class="thumb-inner">
									<div class="thumb-img">
										<img src="<?php echo $row['propic']; ?>" style="width:50px;height:50px;border-radius:50%; object-fit:cover" alt="img">
									</div>
							...
							<div class="lab-content">
								<form action="" id="postform" class="post-form" method="post">
									<textarea placeholder="Whats on your mind. William?" name="postcontent" id="postcontent" class="form-control" rows="3"></textarea>
									<div class="content-type">
										<ul class="content-list">
											<li class="post-submit">
												<input type="submit" value="Post"  id="postbtn" name="postbtn">
											</li>
										</ul>
									</div>
								</form>
